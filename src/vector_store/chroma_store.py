        ...
        try:
            ...
            self.collection = self.client.get_or_create_collection(
                ...
                metadata={
                    ...
                    "hnsw:construction_ef": config.get("vector_store.hnsw.construction_ef", 100),
                    "hnsw:search_ef": config.get("vector_store.hnsw.search_ef", 10)
                }
            )
            
            logger.info(f"ChromaDB initialized at {self.persist_directory} (collection={collection_name})")
