...
class TestRecursiveTextSplitter:
    ...
    def test_split_long_text(self):
        ...
        splitter = RecursiveTextSplitter(chunk_size=50, chunk_overlap=10, length_function="chars")
    ...
    def test_preserves_paragraph_boundaries(self):
        ...
        splitter = RecursiveTextSplitter(chunk_size=500, chunk_overlap=50, length_function="chars")
        text = "Paragraph 1.\n\nParagraph 2.\n\nParagraph 3."
